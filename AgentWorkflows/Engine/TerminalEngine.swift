...
final class TerminalEngine: AgentEngine {
    ...
    init() {
        ...
        appearanceObserver = NSApp.observe(\.effectiveAppearance) { [weak view] _, _ in
    ...
    private static func applyTheme(to view: LocalProcessTerminalView) {
        ...
        if isDark {
            ...
            view.nativeBackgroundColor = NSColor(srgbRed: 0xFA/255, green: 0xFA/255, blue: 0xFA/255, alpha: 1)
            view.nativeForegroundColor = NSColor(srgbRed: 0x38/255, green: 0x3A/255, blue: 0x42/255, alpha: 1)
            view.installColors([
                c(0x69, 0x6C, 0x77), c(0xE4, 0x56, 0x49), c(0x50, 0xA1, 0x4F), c(0xC1, 0x84, 0x01),
                c(0x40, 0x78, 0xF2), c(0xA6, 0x26, 0xA4), c(0x01, 0x84, 0xBC), c(0xAB, 0xB2, 0xBF),
                c(0x4F, 0x52, 0x5E), c(0xE4, 0x56, 0x49), c(0x50, 0xA1, 0x4F), c(0xC1, 0x84, 0x01),
                c(0x40, 0x78, 0xF2), c(0xA6, 0x26, 0xA4), c(0x01, 0x84, 0xBC), c(0xFF, 0xFF, 0xFF),
            ])
        }
    }
